"""
    Builder Pattern : 여러 step을 거쳐 객체를 생성
    - builder : 여러 step을 거치는 객체를 생성
    - director : builder instance
"""
''' director : waitor 
    builder : MargaritaBuilder, CreamyBaconBuilder
    build Pizza instance 
'''
...
class MargaritaBuilder:
    ...
    def add_sauce(self):
        print("adding tomato sauce to margarita")
    ...
    def add_topping(self):
        ...
        print(f"adding topping {topping_desc} to margarita")
    ...
    def bake(self):
        ...
        print(f"baking margarita for {self.baking_time}")
...
class CreamyBaconBuilder:
    ...
    def add_sauce(self):
        print("adding creme_fraiche to creamy bacon")
        self.pizza.sauce = PizzaSauce.creme_fraiche
        time.sleep(STEP_DELAY)
        print("done with creme_fraiche")
    ...
    def add_topping(self):
        ...
        print(f"adding topping {topping_desc} to creamy bacon")
        self.pizza.topping.append([t for t in topping_items])
        time.sleep(STEP_DELAY)
        print("done with topping")
    ...
    def bake(self):
        self.progress = PizzaProgress.baking
        print(f"baking creamy bacon for {self.baking_time}")
        time.sleep(self.baking_time)
        self.progress = PizzaProgress.ready
